...
public protocol MonetixPaywallControllerDelegate: AnyObject {
    ...
    /// Called when custom action is triggered (from remote config)
    func paywallController(
        _ controller: MonetixPaywallController,
...
public extension MonetixPaywallControllerDelegate {
    func paywallControllerDidStartPresenting(_ controller: MonetixPaywallController) {}
    func paywallControllerDidDismiss(_ controller: MonetixPaywallController) {}
    func paywallController(_ controller: MonetixPaywallController, didCancelPurchase product: MonetixProduct) {}
    func paywallController(_ controller: MonetixPaywallController, didFailRenderingWith error: MonetixError) {}
    func paywallController(_ controller: MonetixPaywallController, didPerformAction action: String) {}
}
#endif
